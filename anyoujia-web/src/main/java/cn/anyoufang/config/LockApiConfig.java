 ...
 * @author daiping
 */
public class LockApiConfig extends Observable implements Serializable {
     ...
     */
    public LockApiConfig(String appid, String secret) {
     ...
     */
    public LockApiConfig(String appid, String secret, boolean enableJsApi) {
        this.appid = appid;
        this.secret = secret;
