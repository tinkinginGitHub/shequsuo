...
public class WebSocketTest {
     ...
     * houseid及对应的session
     */
    public static ConcurrentHashMap<Session,String> houseMap = new ConcurrentHashMap<>();
    /**
     * houseid以及对应的排队链表
     */
    public static ConcurrentHashMap<String, LinkedList<String>> houseOrderMap = new ConcurrentHashMap<>();
